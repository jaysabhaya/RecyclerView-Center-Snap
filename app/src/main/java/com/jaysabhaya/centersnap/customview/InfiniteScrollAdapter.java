...
public class InfiniteScrollAdapter<T extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<T>
        implements com.jaysabhaya.centersnap.customview.DiscreteScrollLayoutManager.InitialPositionProvider {
    ...
    private com.jaysabhaya.centersnap.customview.DiscreteScrollLayoutManager layoutManager;
    ...
    public void onAttachedToRecyclerView(@NonNull RecyclerView recyclerView) {
        ...
        if (recyclerView instanceof DiscreteScrollView) {
            layoutManager = (com.jaysabhaya.centersnap.customview.DiscreteScrollLayoutManager) recyclerView.getLayoutManager();
        } else {
