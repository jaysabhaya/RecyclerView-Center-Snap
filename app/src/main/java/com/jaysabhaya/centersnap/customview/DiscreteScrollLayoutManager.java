...
import com.jaysabhaya.centersnap.customview.transform.DiscreteScrollItemTransformer;
...
public class DiscreteScrollLayoutManager extends RecyclerView.LayoutManager {
    ...
    private com.jaysabhaya.centersnap.customview.DSVOrientation.Helper orientationHelper;
    ...
    private com.jaysabhaya.centersnap.customview.RecyclerViewProxy recyclerViewProxy;

    public DiscreteScrollLayoutManager(
            @NonNull Context c,
            @NonNull ScrollStateListener scrollStateListener,
            @NonNull com.jaysabhaya.centersnap.customview.DSVOrientation orientation) {
        this.context = c;
        ...
        this.recyclerViewProxy = new com.jaysabhaya.centersnap.customview.RecyclerViewProxy(this);
    ...
    protected void fill(RecyclerView.Recycler recycler) {
        ...
        layoutViews(recycler, com.jaysabhaya.centersnap.customview.Direction.START, endBound);

        //Layout items after the current item
        layoutViews(recycler, com.jaysabhaya.centersnap.customview.Direction.END, endBound);

        recycleDetachedViewsAndClearCache(recycler);
    }

    private void layoutViews(RecyclerView.Recycler recycler, com.jaysabhaya.centersnap.customview.Direction direction, int endBound) {
    ...
    protected int scrollBy(int amount, RecyclerView.Recycler recycler) {
        ...
        com.jaysabhaya.centersnap.customview.Direction direction = com.jaysabhaya.centersnap.customview.Direction.fromDelta(amount);
    ...
    private boolean onScrollEnd() {
        ...
        com.jaysabhaya.centersnap.customview.Direction scrollDirection = com.jaysabhaya.centersnap.customview.Direction.fromDelta(scrolled);
    ...
    private void onDragStart() {
        ...
        if (isAnotherItemCloserThanCurrent()) {
            com.jaysabhaya.centersnap.customview.Direction direction = com.jaysabhaya.centersnap.customview.Direction.fromDelta(scrolled);
    ...
    public boolean isFlingDisallowed(int velocityX, int velocityY) {
        ...
        com.jaysabhaya.centersnap.customview.Direction direction = com.jaysabhaya.centersnap.customview.Direction.fromDelta(velocity);
    ...
    public void onFling(int velocityX, int velocityY) {
        ...
        int newPosition = currentPosition + com.jaysabhaya.centersnap.customview.Direction.fromDelta(velocity).applyTo(throttleValue);
    ...
    protected int calculateAllowedScrollIn(com.jaysabhaya.centersnap.customview.Direction direction) {
        if (pendingScroll != 0) {
        ...
        if (direction == com.jaysabhaya.centersnap.customview.Direction.START && currentPosition == 0) {
        ...
        } else if (direction == com.jaysabhaya.centersnap.customview.Direction.END && currentPosition == recyclerViewProxy.getItemCount() - 1) {
    ...
    private void startSmoothPendingScroll(int position) {
        ...
        pendingScroll = -scrolled;
        com.jaysabhaya.centersnap.customview.Direction direction = com.jaysabhaya.centersnap.customview.Direction.fromDelta(position - currentPosition);
    ...
    public int getNextPosition() {
        if (scrolled == 0) {
            ...
            return currentPosition + com.jaysabhaya.centersnap.customview.Direction.fromDelta(scrolled).applyTo(1);
        }
    }
    ...
    public void setOrientation(com.jaysabhaya.centersnap.customview.DSVOrientation orientation) {
    ...
    private int getHowMuchIsLeftToScroll(int dx) {
        return com.jaysabhaya.centersnap.customview.Direction.fromDelta(dx).applyTo(scrollToChangeCurrent - Math.abs(scrolled));
    }
    ...
    protected void setRecyclerViewProxy(com.jaysabhaya.centersnap.customview.RecyclerViewProxy recyclerViewProxy) {
        this.recyclerViewProxy = recyclerViewProxy;
    }

    protected void setOrientationHelper(com.jaysabhaya.centersnap.customview.DSVOrientation.Helper orientationHelper) {
